...
| Scope creep | Schedule overrun beyond 6 months | Strictly enforce the project scope documented in the [Roadmap Overview](/roadmap/overview); all new requests need a formal change request before any implementation begins |

...
<Warning>
**Pre-production — all features on this page are Planned.** No game modes have been implemented yet. Mode designs may evolve before development begins. See the [Roadmap](/roadmap) for the planned delivery phasing.
</Warning>
...
Unranked. Matchmaking pairs players by ping preference. No MMR change. Fast queue — intended for casual play when players don't want to risk their rating.

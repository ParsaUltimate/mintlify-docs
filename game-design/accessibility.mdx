---
title: "Accessibility Features and Inclusive Design Goals"
sidebarTitle: "Accessibility"
description: "Planned accessibility features for SET: 3D Edition — colorblind mode, shape assist, adjustable card sizes, text-to-speech, haptics, and responsive device layout."
---
...
<Warning>
**Pre-production — all features on this page are Planned.** Accessibility features are in-scope for v1.0 and must ship at launch. They have not yet been implemented. See the [Hard Boundaries](/onboarding/prerequisites) document for the full in-scope list.
</Warning>
...
| **High-Contrast UI** | Increases contrast on all non-card UI elements (HUD text, buttons, overlays). Specified in the Settings screen UI layout. | Settings → Accessibility → High-Contrast UI (On/Off) |
...
<CardGroup cols={2}>
  ...
  <Card title="UI Flow" icon="layout" href="/architecture/reactive-ui">
    Device responsiveness tables, Settings screen component spec, and the full screen-by-screen UI breakdown.
  </Card>
  <Card title="Game Modes" icon="shield" href="/game-design/modes">

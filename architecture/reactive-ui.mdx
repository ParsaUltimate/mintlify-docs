...
public class HudTopView : MonoBehaviour
{
    ...
    // VContainer calls this before Start() — see di-vcontainer.mdx
    [Inject]
...
<CardGroup cols={2}>
  ...
  <Card title="UI Screen Flow" icon="display" href="/architecture/overview">
    The full screen hierarchy and navigation model built on top of this reactive foundation.
  </Card>
</CardGroup>

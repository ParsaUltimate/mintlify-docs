---
title: "SET: 3D Edition — Project Introduction and Overview"
sidebarTitle: "Introduction"
description: "A pre-production Unity Android game adapting the classic SET card game into a premium 3D digital board game with AI, online, and local multiplayer modes."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Follow the Roadmap" href="/roadmap/overview" icon="map">

---
title: "Game Session Lifecycle: State Machine and Match Orchestration"
sidebarTitle: "Session Lifecycle"
description: "How GameSession orchestrates the match state machine, processes commands, emits reactive state snapshots, handles scoring, and drives the full match lifecycle."
---
...
public enum MatchState
{
    ...
    Validating,         // Third card selected; validation in progress.
                        // In SP: instant. In MP (planned): waiting for server.
...
/// <summary>Player taps a card to select or deselect it.</summary>
